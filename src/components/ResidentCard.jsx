    ...
    <article className="resident">
        ...
        <section className="resident__body">
            ...
            <ul className="resident__list">
                <li className="resident__item"><span className="resident_label">Specie</span><span className="resident__value" >{character?.species}</span></li>
                <li className="resident_item"><span className="resident__label">Origin</span><span className="resident__value">{character?.origin.name}</span></li>
